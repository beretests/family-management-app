...
- Phase 17 loading feedback is integrated, including the app-shell navigation pending indicator.
...
- Add guided onboarding for family setup, children, starter chores, schedule basics, and the first adult invite.
